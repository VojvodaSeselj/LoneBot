...
module.exports = {
  ...
  if (guild.Verify.Enabled === true || guild.Verify.VerifiedRole === "" || guild.Verify.VerifyRole === "" || guild.Verify.Channel === "" || guild.Verify.LogsChannel === "") return message.delete() && message.reply(`Verify is not set up correctly.To see how to set it up do **${guild.Prefix}botconfig**!`).then(m => m.delete(3000));
