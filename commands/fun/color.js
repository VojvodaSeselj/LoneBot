...
module.exports = {
    ...
    if(!["light pink", "pink", "dark pink", "light orange", "orange", "dark orange", "light yellow", "yellow", "dark yellow", "light green", "green", "dark green", "light blue", "blue", "dark blue", "light purple", "purple", "dark purple", "light red", "red", "dark red"].includes(args[0])) return message.reply("You can only choose from colors above!");
